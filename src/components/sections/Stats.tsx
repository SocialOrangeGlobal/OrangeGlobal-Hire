...
export default function Stats() {
  ...
  return (
    <section ref={ref} className="bg-white py-20 lg:py-28 border-b border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="flex flex-col">
            <motion.h2
              variants={fadeUp}
              className="text-4xl sm:text-5xl font-light text-gray-900 mb-12 sm:mb-20"
            >
              Why <span className='text-rh-red font-[300] tracking-tight'>Orange Global</span>
            </motion.h2>

            <motion.div variants={fadeUp}>
              <div className="text-6xl sm:text-7xl font-semibold text-rh-red mb-4">
                #1
              </div>
          ...
          {/* Right Column */}
          <div className="flex flex-col lg:border-l-2 lg:border-gray-200 lg:pl-16 space-y-16 lg:mt-8">
            <motion.div variants={fadeUp}>
              <div className="text-4xl sm:text-5xl font-semibold text-rh-red mb-4">
                {placements} million +
              </div>
