...
import { Shield, User, Building, Scale, Lock, Eye, FileText, CheckCircle2, ChevronRight, Download, Trash2, ArrowRight } from 'lucide-react';
            ...
            <div className="lg:col-span-4 space-y-4 lg:sticky lg:top-32">
              ...
              <div className="bg-rh-teal text-white rounded-3xl p-6 border border-white/5 shadow-sm relative overflow-hidden">
                ...
                <div className="relative z-10 space-y-4">
                  ...
                  <button className="w-full py-3 px-4 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl text-xs font-bold transition-all flex items-center justify-center gap-2">
