      ...
      <main className="flex-1 flex flex-col items-center justify-center p-4 sm:p-12 lg:p-16 bg-white overflow-y-auto custom-scrollbar">
        <div className="w-full max-w-4xl py-8 lg:py-12">
          <div className="flex justify-center w-full">
            ...
            {/* Employer Card - Hidden from view, code intact */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              ...
              whileHover={{ y: -5 }}
              className="hidden group relative bg-white rounded-[32px] p-6 sm:p-8 lg:p-10 shadow-[0_15px_40px_rgba(0,0,0,0.04)] border border-gray-100 cursor-pointer overflow-hidden transition-all"
